...
import 'package:dnd_rolls_app/character/widgets/characters_screen/charactersScreenWidgets/character_card_widget.dart';
...
class BlocCharacterCardWidget extends StatelessWidget {
  const BlocCharacterCardWidget({
    Key? key,
  ...
  @override
  Widget build(BuildContext context) => CharacterCardWidget(
        character: character,
